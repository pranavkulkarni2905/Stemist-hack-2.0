...
public class ProfileController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String uploadPath="C:/Users/NCS/eclipse-workspace/Error_404 Hackathon/src/main/webapp/company-images/"+imageFileName;  // upload path where we have to upload our actual image
